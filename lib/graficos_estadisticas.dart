      ...
      child: BarChart(
        BarChartData(
          ...
          borderData: FlBorderData(
            show: true,
            border: Border.all(color: const Color(0xFF9E9E9E).withOpacity(0.2)),
          ),
              ...
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (value, meta) {
                  ...
                  if (index >= 0 && index < datos.length) {
                    return Padding(
                      padding: const EdgeInsets.only(top: 8.0),
                      child: Text(datos[index]['label'] as String, style: EstilosApp.cuerpoPequeno(context)),
                    );
                  }
                  return const SizedBox();
                },
              ...
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (value, meta) {
                  ...
                  if (index >= 0 && index < datos.length) {
                    return Padding(
                      padding: const EdgeInsets.only(top: 8.0),
                      child: Text(datos[index]['dia'] as String, style: EstilosApp.cuerpoPequeno(context)),
                    );
                  }
                  return const SizedBox();
                },
